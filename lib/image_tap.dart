...
/// trigger from 1 column  to 2 columns (just inner view). Should be greater than `pixelFixedDrawer`
const double pixelWidth1Column = 700;
/// trigger from 2 columns to 3 columns (just inner view). Should be greater than `pixelWidth1Column`
const double pixelWidth2Columns = 1000;
/// trigger from 3 columns to 4 columns (just inner view). Should be greater than `pixelWidth2Columns`
